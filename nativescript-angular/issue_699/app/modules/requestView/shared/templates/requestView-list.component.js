...
var RequestViewListComponent = (function () {
    ...
    RequestViewListComponent.prototype.isComplete = function (status) {
        return status == shared.RequestStatuses.Completed;
    };
    RequestViewListComponent.prototype.statusBadgeClass = function (status) {
        var result = "";
    ...
    ], RequestViewListComponent.prototype, "embedded", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
...
//# sourceMappingURL=requestView-list.component.js.map