...
export class MyPlanHelpInfoComponent implements OnInit,AfterViewInit  {
    ...
    public constructor(private params: ModalDialogParams, private modalParams: ModalDialogService,public _globals: Globals,
