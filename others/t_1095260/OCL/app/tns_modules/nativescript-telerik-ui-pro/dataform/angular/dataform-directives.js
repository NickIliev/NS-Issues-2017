...
var TKPropertyEditorirective = (function () {
    ...
    TKPropertyEditorirective.decorators = [
        { type: core_1.Directive, args: [{
                    selector: "TKPropertyEditor"
                },] },
    ];
    /** @nocollapse */
    TKPropertyEditorirective.ctorParameters = function () { return [
        { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef,] },] },
    ]; };
...
var TKPropertyGroupTitleStyle = (function () {
    ...
    TKPropertyGroupTitleStyle.decorators = [
        { type: core_1.Directive, args: [{
                    selector: "[tkPropertyGroupTitleStyle]"
                },] },
    ];
    /** @nocollapse */
    TKPropertyGroupTitleStyle.ctorParameters = function () { return [
        { type: TKPropertyGroupDirective, decorators: [{ type: core_1.Inject, args: [TKPropertyGroupDirective,] },] },
        { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef,] },] },
    ]; };
...
var TKPropertyEditorStyle = (function () {
    ...
    TKPropertyEditorStyle.decorators = [
        { type: core_1.Directive, args: [{
                    selector: "[tkPropertyEditorStyle]"
                },] },
    ];
    /** @nocollapse */
    TKPropertyEditorStyle.ctorParameters = function () { return [
        { type: TKPropertyEditorirective, decorators: [{ type: core_1.Inject, args: [TKPropertyEditorirective,] },] },
        { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef,] },] },
    ]; };
...
var TKEntityPropertyValidators = (function () {
    ...
    TKEntityPropertyValidators.decorators = [
        { type: core_1.Directive, args: [{
                    selector: "[tkEntityPropertyValidators]"
                },] },
    ];
    /** @nocollapse */
    TKEntityPropertyValidators.ctorParameters = function () { return [
        { type: TKEntityPropertyDirective, decorators: [{ type: core_1.Inject, args: [TKEntityPropertyDirective,] },] },
        { type: core_1.ElementRef, decorators: [{ type: core_1.Inject, args: [core_1.ElementRef,] },] },
    ]; };
...
//# sourceMappingURL=dataform-directives.js.map