...
var RadListView = (function (_super) {
    ...
    function RadListView() {
        ...
        this._ios.autoresizingMask = 2 /* FlexibleWidth */ | 16 /* FlexibleHeight */;
    ...
    RadListView.prototype._eachChildView = function (callback) {
        if (this._realizedCells) {
            this._realizedCells.forEach(function (value, key) {
                ...
                if (value.view.HeaderView) {
                    callback(value.view.HeaderView);
                }
                if (value.view.FooterView) {
                    callback(value.view.FooterView);
                }
            }, this);
        }
    };
    ...
    RadListView.prototype.getItemTemplateContent = function () {
        ...
        if (this.headerItemTemplate) {
            cellViews.headerItemTemplate = this.getViewForViewType(commonModule.ListViewViewTypes.HeaderView);
        }
        if (this.footerItemTemplate) {
            cellViews.footerItemTemplate = this.getViewForViewType(commonModule.ListViewViewTypes.FooterView);
        }
        return cellViews;
    };
