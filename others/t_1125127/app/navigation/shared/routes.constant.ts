...
import { AssetViewComponent } from "../../modules/assetView/assetView.component";
...
export const ROUTES: Routes = [
	...
	{ path: "assetView", component: AssetViewComponent },
	{ path: "assetView/:id", component: AssetViewComponent },
