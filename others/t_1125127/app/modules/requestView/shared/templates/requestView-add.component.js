...
var RequestViewAddComponent = (function () {
    ...
    function RequestViewAddComponent(service) {
        ...
        this.itemsToShow = [];
        this.selectedSite = new BehaviorSubject_1.BehaviorSubject("");
        this.selectedBuilding = new BehaviorSubject_1.BehaviorSubject("");
        this.selectedSpace = new BehaviorSubject_1.BehaviorSubject("");
        this.selectedPriority = new BehaviorSubject_1.BehaviorSubject("");
        this.selectedJobType = new BehaviorSubject_1.BehaviorSubject("");
        this.siteMap = {};
        this.buildingMap = {};
        this.spaceMap = {};
        this.priorityMap = {};
        ...
        this.service.getDbCollection('Priority').subscribe(function (items) {
            ...
            items.forEach(function (item) {
                ...
                if (item.Id == _this.item.data.Priority) {
                    _this.selectedPriority.next(item.Name);
        ...
        this.service.getDbCollection('JobType').subscribe(function (items) {
            items.forEach(function (item) {
                ...
                if (item.Id == _this.item.data.JobType) {
                    _this.selectedJobType.next(item.Name);
                    setTimeout(function () { }, 0);
                }
            });
        ...
        this.service.getDbCollection('Site').subscribe(function (items) {
            items.forEach(function (item) {
                ...
                if (item.Id == _this.item.data.Site) {
                    _this.selectedSite.next(item.Name);
                    setTimeout(function () { }, 0);
                }
            });
        ...
        this.service.getDbCollection('Building', buildingFilter).subscribe(function (items) {
            items.forEach(function (item) {
                ...
                if (item.Id == _this.item.data.Building) {
                    _this.selectedBuilding.next(item.Name);
                    setTimeout(function () { }, 0);
                }
            });
        ...
        this.service.getDbCollection('Space', spaceFilter).subscribe(function (items) {
            items.forEach(function (item) {
                ...
                if (item.Id == _this.item.data.Space) {
                    _this.selectedSpace.next(item.CodeName);
                    setTimeout(function () { }, 0);
                }
            });
    ...
    RequestViewAddComponent = __decorate([
        ...
        __metadata('design:paramtypes', [common.RequestViewMockService])
