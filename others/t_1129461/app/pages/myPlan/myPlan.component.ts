    ...
    public constructor(private _routerExtensions: RouterExtensions,
        ...
        this.accordionList = {
            ...
            provisionList: [
                ...
                { title: "Co-Pays", provisionHeader: [{ text: "Office Visit", amount: "25/35" }, { text: "Behavioral Health", amount: "25" }, { text: "Emergency Room", amount: "150" }, { text: "Preventive", amount: "0" }], provisionBody: ["$0 for Enhanced Benefits Tier", "$250 per member", "$1500 per family per plab year"], provisionFooter: "For Standard Benefits Tier hospital service only. (counts toward Basic Benefits Tier deductible)" },
                { title: "Deductible", provisionHeader: [{ text: "Office Visit", amount: "25/35" }, { text: "Behavioral Health", amount: "25" }, { text: "Emergency Room", amount: "150" }, { text: "Preventive", amount: "0" }], provisionBody: ["$1500 per family per plab year"], provisionFooter: "" },
                { title: "Out-of-Pocket Maximum", provisionHeader: [{ text: "Emergency Room", amount: "150" }, { text: "Preventive", amount: "0" }], provisionBody: ["$1500 per family per plab year"], provisionFooter: "For Standard Benefits Tier hospital service only." },
                { title: "Overall Benefit Maximum", provisionHeader: [{ text: "Emergency Room", amount: "150" }, { text: "Preventive", amount: "0" }], provisionBody: ["$1500 per family per plab year"], provisionFooter: "For Standard Benefits Tier hospital service only." }
            ]
        };
    }
