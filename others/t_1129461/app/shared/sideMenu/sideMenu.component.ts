...
export class SideMenuComponent implements OnInit, AfterViewInit {
  ...
  public onLoaded() {
    if (this.drawer && this.drawer.android) {
  ...
  logOff() {
    ...
    this.showIndicator(this._router.url.toString(),"/login");
  ...
  loginCheckNavigate(toPage) {
    ...
    if (this._globals.isLoggedIn) {
      this.showIndicator(this._router.url.toString(),"/" + toPage);
  ...
  nav() {
    ...
    if (this._globals.isLoggedIn){
      this.showIndicator(this._router.url.toString(),"/happy");
  ...
  homeNav() {
    if (this._globals.isLoggedIn) {
      ...
      this.closeSideDrawer("/personal_info/reg_home");
 ...
 this.drawer.closeDrawer();
    ...
    //     console.log("current url"+this._router.url.toString());
