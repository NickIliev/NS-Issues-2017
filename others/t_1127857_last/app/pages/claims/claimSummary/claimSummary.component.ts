...
export class ClaimSummaryComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('claimSummaryListView') claimSummaryListView;
    ...
    public showWindow(customWindow, duration) {
        this.claimSummaryListView.nativeElement.isUserInteractionEnabled = false;
        setTimeout(function () {
    ...
    public hideWindow(customWindow, duration) {
        this.claimSummaryListView.nativeElement.isUserInteractionEnabled = true;
        setTimeout(function () {
