    ...
    viewModel.load = function () {
        ...
        try {
            ...
            var requestOptions = {
                ...
                content: JSON.stringify({ RequisitionID: that.reqID, PatientMRN: that.patientMRN, Agreement: that.agreement, Skip: 0, Take: 100 })
            };
                ...
                function (response) { // success callback
                    ...
                    if (data.Count > 0) {
                        ...
                        data.Data.forEach(function (item) {
                            i++;
                            //console.log(i++);
                            console.log(i + ". " + item.RequisitionID + " - " + item.QOClassificationEntryName);
